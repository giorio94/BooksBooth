...
public class BorrowedBooksFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View noBooksView = view.findViewById(R.id.fbb_no_books);
        RecyclerView recyclerView = view.findViewById(R.id.fbb_recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        FirebaseRecyclerOptions<Book> options = Book.getBorrowedBooksReference(LocalUserProfile.getInstance().getUserId());
